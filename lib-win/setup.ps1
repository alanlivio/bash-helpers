...
function bh_win_scheduledtask_list_enabled() {
...
function bh_win_scheduledtask_disable() {
...
function bh_optimize_windows() {
  ...
  bh_win_scheduledtask_disable @tasks
}

function bh_optimize_disable_shortcut_altgr() {
...
function bh_optimize_disable_password_policy {
  Invoke-Expression $bh_log_func
  $tmpfile = New-TemporaryFile
